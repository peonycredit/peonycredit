...
const int64_t nBlockAlgoWorkWeightStart = 476000; // block where algo work weighting starts
const int64_t nBlockAlgoNormalisedWorkStart = 477000; // block where algo combined weight starts
const int64_t nBlockAlgoNormalisedWorkDecayStart = 478500; // block where weight decay starts
const int64_t nBlockAlgoNormalisedWorkDecayStart2 = 479000; // block where weight decay starts
const int64_t nBlockSequentialAlgoRuleStart = 477000; // block where sequential algo rule starts
const int64_t nBlockSequentialAlgoRuleStart2 = 478000; // block where sequential algo rule starts
const int nBlockSequentialAlgoMaxCount = 3; // maximum sequential blocks of same algo
const int nBlockSequentialAlgoMaxCount2 = 1; // maximum sequential blocks of same algo
const int64_t nBlockTimeWarpPreventStart = 477500; // block where time warp 1 prevention starts
const int64_t nBlockTimeWarpPreventStart2 = 478000; // block where time warp 2 prevention starts
const int64_t nBlockDiffAdjustV2 = 478000; // block where difficulty adjust V2 starts
const int64_t nBlockTimeWarpPreventStart3 = 480000; // block where time warp 3 prevention starts
const int64_t nBlockTimeWarpPreventStart4 = 523000; // block where time warp 3 prevention starts
